      ...
      <div className='bg-white mx-2 my-4 px-3 py-4 rounded-md min-h-screen'>
        ...
        <div className='my-4 overflow-y-auto h-[48vh] overflow-x-hidden'>
          <Accordion type="single" collapsible>
            <AccordionItem  className='border-none animate-pulse' value="item-1">
              <AccordionTrigger disabled className='text-base'>
                <div className='flex items-center justify-between w-full'>
                  <div className='flex items-center gap-2 '>
                    <div className='bg-[#6941c5] p-2 rounded-full w-fit animate-pulse'>
              ...
              <AccordionContent>
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 items-start justify-items-center'>
                  ...
                  <div>
                    ...
                    <div className='text-gray-600 mb-4 '>Author</div>
                  </div>
                  <div>
            ...
            <AccordionItem className='border-none animate-pulse' value="item-2">
              <AccordionTrigger disabled className='text-base'>
                <div className='flex items-center justify-between w-full'>
                  <div className='flex items-center gap-2 '>
            ...
            <AccordionItem className='border-none animate-pulse' value="item-3">
              <AccordionTrigger disabled className='text-base'>
                <div className='flex items-center justify-between w-full'>
                  <div className='flex items-center gap-2 '>
                    <div className='bg-[#6941c5] p-2 rounded-full w-fit'>
