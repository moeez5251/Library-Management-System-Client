    ...
    return (
        <>
            ...
            <div className='flex items-center justify-between my-4 mx-2'>
                ...
                <button onClick={() => { setDelete(true) }} className='bg-red-600 font-semibold text-sm text-white px-3 py-2 rounded-md cursor-pointer scale-100 hover:scale-105 transition-transform'>Delete Account</button>
            </div>
